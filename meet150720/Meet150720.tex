...
\begin{center}
\includegraphics[scale=0.65]{chain_mupi.pdf}
\captionof{figure}{The sampling chains of $(\mu_1, \mu_2, \pi_0, \pi_1)$}
\end{center}

\begin{center}
\includegraphics[scale=0.6]{post_pi.pdf}
\captionof{figure}{The Posterior density of $(\mu, \pi)$ where the legend shows the posterior mean of each parameter}
\end{center}
