...
# Prob.GS_SS_BS(K=3, MGS=M.GS, MSS=M.SS, MBS=M.BS, I_GS=I_GS, Pr_Lj=tmp, SS_TPR, BS_TPR, BS_FPR, logscale=TRUE)
...
Joint.Density.Cpp = function(K, Smax, MGS, I_GS, MSS, MBS, Mbs_ctrl, N_ctrl, 
                                    latent.cell.probs, mus, pis, ss_tpr, bs_tpr, bs_fpr, DirichPar, BetaPars, 
                                    logscale=TRUE, cell.labels=NULL, Lall_mat=NULL)
{

      lik.case.withGS = Prob.GS_SS_BS(K=K, MGS=MGS, MSS=MSS, MBS=MBS, I_GS=I_GS, 
                                    Pr_Lj=latent.cell.probs, ss_tpr, bs_tpr, bs_fpr, logscale=TRUE, cell.label=cell.labels)
...
##############################################################
# t0=proc.time()
# Joint.Density.Cpp(K=3, Smax=3, MGS=M.GS, I_GS=I_GS, MSS=M.SS, MBS=M.BS, Mbs_ctrl=M.BS.ctrl, N_ctrl=1000, 
