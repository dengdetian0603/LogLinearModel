...
Data = AQE.simulate(K=5, Smax=5, N=5000, theta2=theta2, ss_tpr=ss_tpr, bs_tpr=bs_tpr, bs_fpr=bs_fpr, seed=134)
...
tmp = turboem(par = c(ss_tpr, bs_tpr, bs_fpr, par0), 
      fixptfn = FixMap, method = "squarem", parallel = TRUE) 
...
cbind(par0[1:15], tmp$pars[16:30], as.vector(Data$Beta))
